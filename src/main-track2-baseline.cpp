...
#define NUM_STEPS 601    /* Number of real-time iterations. */
...
int main(int argc, char const *argv[]) {
  ...
  FILE * fp_time;
  if (opt==15) {
    fp_whole = fopen ("../result/baseline/track2/N15/traj_whole.txt", "w");
    fp_actual = fopen ("../result/baseline/track2/N15/traj_actual.txt", "w");
    fp_time = fopen ("../result/baseline/track2/N15/traj_time.txt", "w");
  } else if (opt==30) {
    fp_whole = fopen ("../result/baseline/track2/N30/traj_whole.txt", "w");
    fp_actual = fopen ("../result/baseline/track2/N30/traj_actual.txt", "w");
    fp_time = fopen ("../result/baseline/track2/N30/traj_time.txt", "w");
  }
...
*/
    ...
    for (i = N + 1 - next_n; i < N + 1; ++i)  {
      ...
      acadoVariables.x[ i*NX + 0 ] = acadoVariables.x[ (N-next_n)*NX + 0 ];
    }
