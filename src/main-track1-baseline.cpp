...
int main(int argc, char const *argv[]) {
  ...
  FILE * fp_time;
  if (opt==15) {
    fp_whole = fopen ("../result/baseline/track1/N15/traj_whole.txt", "w");
    fp_actual = fopen ("../result/baseline/track1/N15/traj_actual.txt", "w");
    fp_time = fopen ("../result/baseline/track1/N15/traj_time.txt", "w");
  } else if (opt==30) {
    fp_whole = fopen ("../result/baseline/track1/N30/traj_whole.txt", "w");
    fp_actual = fopen ("../result/baseline/track1/N30/traj_actual.txt", "w");
    fp_time = fopen ("../result/baseline/track1/N30/traj_time.txt", "w");
  }
